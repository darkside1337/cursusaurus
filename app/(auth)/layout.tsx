...
export default function AuthLayout({
  ...
  return (
    <div className="bg-fog-white font-sohne text-ink-black min-h-svh flex flex-col justify-between selection:bg-blush-peach selection:text-sienna-brown">
      <header className="w-full max-w-[1200px] mx-auto px-6 pt-6 flex items-center justify-between relative">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 font-sohne text-caption text-slate-gray hover:text-ink-black transition-colors z-10"
        >
